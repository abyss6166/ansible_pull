...
env DBUS_SESSION_BUS_ADDRESS=unix:path=/run/user/1000/bus xfconf-query -c xfce4-power-manager /xfce4-power-manager/blank-on-ac -n -t int -s 30
env DBUS_SESSION_BUS_ADDRESS=unix:path=/run/user/1000/bus xfconf-query -c xfce4-power-manager /xfce4-power-manager/dpms-on-ac-off -n -t int -s 60
env DBUS_SESSION_BUS_ADDRESS=unix:path=/run/user/1000/bus xfconf-query -c xfce4-power-manager /xfce4-power-manager/dpms-on-ac-sleep -n -t int -s 45
